...
var ProductService = /** @class */ (function () {
    ...
    ProductService.prototype.getEmployees = function () {
        var _this = this;
        this.http.get(this.apiUrl + '/api/Employees').toPromise().then(function (res) { return _this.listEmployees = res; });
        //console.log(this.listEmployees);
    };
    ProductService.prototype.getSubjects = function () {
        var _this = this;
        this.http.get(this.apiUrl + '/api/Subjects').toPromise().then(function (res) { return _this.listSubjects = res; });
    };
